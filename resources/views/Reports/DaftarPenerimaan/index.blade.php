...
@section('title','Report Daftar Penerimaan')
...
{{-- datatable --}}
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Report Daftar Penerimaan</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                        ...
                        <div class="col-6">
                            <div class="card shadow">
                                <div class="card-body">                                    
                                    ...
                                    <label for="kode_faktur">Penerimaan Dari</label>
                                    <div >
                                        <input type="radio" name="urut" id="urut-kasir" value="1" onclick="penerimaan(1)" checked>
                                        <label for="urut-kasir">Kasir</label>&nbsp;
                                      
                                        <input type="radio" name="urut" id="urut-transfer-bank" onclick="penerimaan(2)" value="2">
                                        <label for="urut-transfer-bank">Transfer Bank</label>
                                    </div> 
                                    ...
                                    <div class="kasir">
                                        ...
                                        <br>
                                        <select class="nama_kasir  select_box" multiple="multiple" name="nama_kasir[]" style="width: 100%;" data-placeholder="Pilih Nomor Tanda Terima">
                                    ...
                                    <div class="bank">
                                        <label >Nomor Pencairan Bank</label>
                                        <br>
                                        <select class="kode_bank select_box " multiple="multiple" name="kode_bank[]" style="width: 100%;" data-placeholder="Pilih Nomor Pencairan Bank">
                                            <option value="0">Pilih Semua</option>
                                            <option value="1">Unit</option>
                                        </select> 
                                    </div>    
                            ...
                            <div class="card shadow">
                                <div class="card-body">
                                    ...
                                    <div class="kasir">
                                        ...
                                        <br>
                                        <select class="nama_kasir select_box" multiple="multiple" name="nama_kasir[]" style="width: 100%;" data-placeholder="Pilih Nama Kasir">
                                            <option value="0">Pilih Semua</option>
                                            <option value="1">Unit</option>
                                        </select> 
                                    </div>
                                    ...
                                    <div class="bank">
                                        ...
                                        <br>
                                        <select class="kode_bank select_box " multiple="multiple" name="kode_bank[]" style="width: 100%;" data-placeholder="Pilih Kode Bank">
                                            <option value="0">Pilih Semua</option>
                                            <option value="1">Unit</option>
                                        </select> 
                                    </div>  
                                    ...
                                    <label >Media Bayar</label>
                                    <br>
                                    <select class="media_bayar select_box" multiple="multiple" name="media_bayar[]" style="width: 100%;" data-placeholder="Pilih Media Bayar">
                                        <option value="0">Pilih Semua</option>
